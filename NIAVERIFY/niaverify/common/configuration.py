...
from niaverify.common.utils import ReluApproximation, OSIPMode
import multiprocessing
import torch

class Logger():
    LOGFILE: str = "niaverify_log.txt"
    SUMFILE: str = "vniaverify_summary.txt"
...
class Verifier():
    ...
    #whether to try verification via pre_attack
    PRE_ATTACK:bool = True
...
class Config:
    ...
    def set_fc_defaults(self, nn):
        ...
        if nn.head.input_size < 10:
            ...
            if relus < 1000:
                self.set_param_if_not_set('branching_depth', 3)
